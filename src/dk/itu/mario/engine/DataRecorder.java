...
//			levelScene.levelRecorder.enemyR.interact.add(new DataEntry(EnemyRecorder.GREEN_TURTLE, EnemyRecorder.UNLEASHED, 2982 - levelScene.timeLeft,x,y));
    ...
    private double enterRating() {
        ...
        while (!flag) {
            System.out.println("Please rate this map from 0-10 ('q' to quit): ");
    ...
    private String getFeatureVector(double rating) {
        MyLevel temp = (MyLevel) levelScene.currentLevel;
        String fv = String.format("%f,%f,%f,%f,%f,%d,%d,%d,%d,%d,%f",
                temp.probBuildJump,
                temp.probBuildCannons,
                temp.probBuildHillStraight,
                temp.probBuildTubes,
                temp.probBuildStraight,
                temp.difficulty,
                temp.BLOCKS_COINS,
                temp.BLOCKS_EMPTY,
                temp.BLOCKS_POWER,
    ...
    private void append(String filename, String details) {
